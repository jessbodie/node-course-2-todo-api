...
describe('PATCH /todos/:id', () => {
    ...
    it('should update the todo', (done) => {
        ...
        request(app)
            ...
            .expect(200)
            .expect((res) => {
                expect(res.body.todo.text).toBe("really?");
                expect(res.body.todo.completed).toBe(true);
                expect(res.body.todo.completedAt).toBeA('number');                ('number');
            })
            .end(done);
    });
    ...
    it('should clear completedAt when todo is not completed', (done) => {
        ...
        request(app)
            .patch(`/todos/${hexID}`)
                ...
                .expect(200)
                .expect((res) => {
                    expect(res.body.todo.text).toBe("Oh yeah!");
